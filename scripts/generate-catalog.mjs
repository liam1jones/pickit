...
function vendorFile(varName, displayName, items) {
  const banner = `// AUTO-GENERATED by scripts/generate-catalog.mjs from References/NSIM Item Master 4-16-26 .csv\n// Vendor: ${displayName} · ${items.length} items. Re-run the script to refresh.\n`;
...
if (existsSync(OUT_DIR)) {
  ...
  for (const e of existing) {
    ...
    if (head.includes("AUTO-GENERATED by scripts/generate-catalog.mjs")) {
...
const INDEX_FILE = `// AUTO-GENERATED by scripts/generate-catalog.mjs — re-run to refresh.
