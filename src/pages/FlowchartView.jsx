...
const ROLES = [
  {
    ...
    actions: ["Open ticket (site, DH, rack, part, qty)", "Confirm materials received", "Comment / attach Asana link"],
  },
  {
    key: "DCM",
  ...
  },
  {
    ...
    actions: ["Pick & stage materials", "Scan QR tag to advance", "Flag excess / confirm return"],
  },
  {
    key: "Vendor",
    ...
    actions: ["See assigned tickets", "View site & part lists", "Acknowledge schedule (post-MVP)"],
  },
  {
    key: "Accounting",
    label: "Accounting",
    ...
    actions: ["Pull closed-ticket exports", "Verify bin-transfer GL postings", "Monthly $ movement reports"],
  },
];
...
const INTEGRATIONS = [
  ...
  },
  {
    name: "Tableau (MVP)",
    color: "#2dd4bf",
    role: "Inventory & SLA dashboards",
    notes: [
      "“What’s on the shelf?” live on-hand view for DCTs",
      "Cycle-time + breach dashboards for DCMs",
      "$ movement export for Accounting",
    ],
  },
];
