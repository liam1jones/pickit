...
// Vendor: Seagate · 5 items. Re-run the script to refresh.
...
const seagateCatalog: CatalogItem[] = [
  ...
  },
  {
    ...
    model: 'Seagate 1TB Enterprise Capacity 2.5 Internal Hard Disk Drive SATA 6.0Gb/s 7200 RPM 128MB Cache',
    manufacturer: 'Seagate',
    category: 'hardware',
